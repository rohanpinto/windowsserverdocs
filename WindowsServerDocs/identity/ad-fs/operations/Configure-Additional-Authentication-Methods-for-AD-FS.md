...
|-|-|-|
|1Kosmos|BlockID Passwordless MFA for Microsoft ADFS|[BlockID MFA Config for Active Directory Federation Services](https://www.1kosmos.com/workforce-solutions/active-directory-federation-services)|aPersona|aPersona Adaptive Multi-Factor Authentication for Microsoft ADFS SSO|[aPersona ASM ADFS Adapter](https://www.apersona.com/adfs)|
